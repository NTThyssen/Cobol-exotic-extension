...
CLASSIC_COMMENT_TAG : TEXT TEXT TEXT TEXT TEXT TEXT '*' -> pushMode(CLASSIC_COMMENT_MODE);
CLASSIC_CONTINUATION : '-';
CLASSIC_LINE_NUMBER : TEXT TEXT TEXT TEXT TEXT TEXT  -> skip;
CLASSIC_EOL_COMMENT : TEXT TEXT TEXT TEXT TEXT TEXT TEXT TEXT  -> channel(HIDDEN);

ID_DIVISION_TAG : ID DIVISION ;

NIST_FLAG1 : (A | B | C | F | H | I | P | S | T | U | X | Y) -> skip;
NIST_FLAG2 : (G | J);
NIST_IGNORED_LINE : TEXT TEXT TEXT TEXT TEXT TEXT (NIST_FLAG1 | NIST_FLAG2) TEXT* -> skip;
...
CD_CLASSIC_EOL_COMMENT : TEXT TEXT TEXT TEXT TEXT TEXT TEXT TEXT -> skip;
...
BD_CLASSIC_EOL_COMMENT : TEXT TEXT TEXT TEXT TEXT TEXT TEXT TEXT  -> skip;
...
ES_CLASSIC_LINE_NUMBER : TEXT TEXT TEXT TEXT TEXT TEXT -> skip;
...
EC_CLASSIC_LINE_NUMBER : TEXT TEXT TEXT TEXT TEXT TEXT -> skip;
...
ED_CLASSIC_LINE_NUMBER : TEXT TEXT TEXT TEXT TEXT TEXT  -> skip;